...
| public SystemePlanetaire(String nom)                                                  | Constructeur de la classe                                                                                                                                                                      |
| ArrayList<CorpsCeleste> listeTrieeParMasse()                                          | Méthode retournant une liste triée par masse de l'ensemble des corps célestes appartenant au système planétaire courant                                                                        |
| ArrayList<CorpsCeleste> listeTrieeParRayon()                                          | Méthode retournant une liste triée par rayon de l'ensemble des corps célestes appartenant au système planétaire courant                                                                        |
| ArrayList<CorpsCeleste> extraitListeCorpsCelesteParMasse(double masseMax)             | Méthode permettant de retourner l’ensemble des corps célestes dont la valeur de masse est inférieure au paramètre masseMax                                                                     |
